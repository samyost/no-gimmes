...
try {
  ...
  ok('hub offers Best Ball under side action', await until(()=>p.locator('#sheetbox .hubrow[data-act="bb"]').count().then(n=>n===1)));
  await p.locator('#sheetbox .hubrow[data-act="bb"]').click();
